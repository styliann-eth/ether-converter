...
import {
  ...
  ApplyNewFee,
  SetNewMATime
} from "../generated/CurveStableSwap/CurveStableSwap"
...
export function createTokenExchangeUnderlyingEvent(
  ...
  let tokenExchangeUnderlyingEvent =
    changetype<TokenExchangeUnderlying>(newMockEvent())
...
export function createRemoveLiquidityImbalanceEvent(
  ...
  let removeLiquidityImbalanceEvent =
    changetype<RemoveLiquidityImbalance>(newMockEvent())
